...
INSERT INTO scenes (description, title, target, right_command, inventory)
VALUES
    -- Cena 01
    ...
    -- Cena 02
    ('Após a demissão, você passa a noite refletindo sobre o que fazer. Uma hora o dinheiro do acerto vai acabar, você decide investir em um carro usado para poder iniciar uma nova fase da sua vida. No dia seguinte, você entra na OLX e encontra dois carros que se encaixam no seu orçamento: um MONZA e um UNO. Cada carro tem suas vantagens e desvantagens, e a escolha certa pode fazer a diferença na sua jornada.','Você está de-mi-ti-do! E agora zé?',3,'get monza','dinheiro'),

    -- Cena 03
    ('Já no carro, cuidadosamente preparado. Você precisa se decidir de algo muito importante, a trilha sonora! Pega dois CDs para ouvir no RADIO do carro, SLAYER e PANTERA, qual ouvir nessa jornada?','Partiu Paraguay',4,'use pantera with radio','dinheiro, monza'),

    -- Cena 04
    ('Com o carro preparado, você parte rumo ao Paraguai. As estradas são longas e esburacas, mas a adrenalina e a determinação te mantém focado. Durante a viagem, você escuta Pantera no radio e se concentra em seus objetivos. Ao chegar à fronteira, você pega seu MAPA e precisa decidir seu destino, CIUDAD_DEL_ESTE ou PEDRO_JUAN_CABALLERO','As estradas no Brasil são uma m3Rd@!',5,'use pedro_juan_caballero','dinheiro, monza'),

    -- Cena 05
    ('Em Pedro Juan Caballero, você se infiltra no mercado clandestino. As opções são variadas: WHISKY, CIGARRO, e outros itens de alto valor estão disponíveis. Cada decisão que você toma aqui é crucial; qualquer erro pode arruinar sua viagem de volta ao Brasil. Com o carro carregado, você precisa escolher como proceder para garantir um lucro sem atrair atenção indesejada.','Dinheiro na mão!',6,'get derby','dinheiro, monza'),

    -- Cena 06
    ('Final da história, agora é só continuar fazendo dinheiro pra comprar o MÉ, LEITE das crianças e o MODDESS da muié.','Nunca é um final!',1 ,'use mé','dinheiro, monza, derby');
